...
_PROVIDERS: dict[str, ProviderSpec] = {
    ...
    "orcarouter": ProviderSpec(
        ...
        default_model="deepseek/deepseek-v4-pro-free",
    ...
    "zenmux": ProviderSpec(
        key_fields=("zenmux_api_key", "openai_api_key"),
        base_url_field="zenmux_base_url",
        default_base_url="https://zenmux.ai/api/v1",
        default_model="gpt-4o",
        fast_model="gpt-4o-mini",
    ),
    "gmicloud": ProviderSpec(
        key_fields=("gmi_api_key", "openai_api_key"),
        base_url_field="gmi_base_url",
        default_base_url="https://api.gmi-serving.com/v1",
        default_model="deepseek-ai/DeepSeek-R1",
        fast_model="deepseek-ai/DeepSeek-R1",
    ),
    "bai": ProviderSpec(
        key_fields=("bai_api_key",),
        base_url_field="bai_base_url",
        default_base_url="https://api.b.ai/v1",
        default_model="deepseek-v4-flash",
        fast_model="deepseek-v4-flash",
    ),
    "opencode": ProviderSpec(
        key_fields=("opencode_api_key",),
        base_url_field="opencode_base_url",
        default_base_url="https://opencode.ai/zen/v1",
        default_model="x-preview-f-free",
        fast_model="x-preview-f-free",
    ),
    "ollama": ProviderSpec(
        key_fields=(),
        base_url_field="openai_base_url",
...
_OPENAI_COMPAT_PROVIDERS = {
    "openai", "qwen", "gemini", "openrouter", "orcarouter", "deepseek", "groq", "grok", "xai", "zai", "zenmux", "gmicloud", "bai", "opencode", "ollama",
}
