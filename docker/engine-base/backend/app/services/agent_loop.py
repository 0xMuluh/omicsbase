...
The engine consumes the shared executor contract (``build_messages``,
``execute_tool``, ``initial_events``, ``final_event``, ``fallback_events``,
``tool_completed_event``), so lens executors plug in unchanged.
"""
