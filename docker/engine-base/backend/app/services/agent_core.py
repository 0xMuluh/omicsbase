...
The native agent loop owns the conversation. This module intentionally
contains only runtime-neutral values shared by domain executors and that
loop: budgets, tool-call results, user-facing labels, and bounded audit
arguments."""
