...
SECRET_PATTERNS: list[re.Pattern] = [
    ...
    re.compile(
        r"\b(?:AWS_SECRET_ACCESS_KEY|AWS_ACCESS_KEY_ID|DATABASE_URL|DATABASE_URI|REDIS_URL|OPENAI_API_KEY|ANTHROPIC_API_KEY|ZAI_API_KEY|SECRET_KEY|PRIVATE_KEY)\s*=\s*[^\s]+",
        re.IGNORECASE,
    ),
