...
Priorities: eliminate minified-JavaScript replacement; isolate branding/theme edits; replace full copied backend modules with small versioned patches or supported extension points; recover the engine image build definition.
